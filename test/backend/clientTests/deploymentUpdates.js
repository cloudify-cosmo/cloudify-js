...
describe('deploymentUpdates:', function(){
    ...
    it('should update from a url with default workflow and get it', function(done){
        testClient.deploymentUpdates.update('nodecellar_updated', 'https://github.com/cloudify-cosmo/cloudify-nodecellar-example/archive/3.3.1.zip', null, 'local-blueprint.yaml', {skipInstall: false, skipUninstall:false}, function(err, response, body) {
